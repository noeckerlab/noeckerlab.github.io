...
<img alt = 'Tree of Eggerthellaceae isolates and hosts' width='320' src='/images/host_tree_mod.png' align='left' style='margin:0px 20px 10px 0px' border='1px'/>
<img alt = 'E. lenta colonies' width='150' src='/images/ElentaColonies.jpeg' align='left' style='margin:0px 20px 10px 0px' border='1px'/>
...
<img alt = 'Schematic of Flux Balance Analysis' width='500' src='/images/fba_schematic2.png' align='left' style='margin:0px 20px 10px 0px' border='1px'/>
...
<img alt = 'Differentially abundant microbial amplicons in lab mice with a behavioral gene mutation, from Buffington Cell 2021' width='350' src='/images/fig_buffington.jpg' align='left' style='margin:0px 20px 10px 0px' border='1px' padding='5px'/>
